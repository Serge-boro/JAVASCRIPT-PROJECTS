// In this case I worked with local date but in my store projects I've used server date using async/await and axios methods
...
window.addEventListener('DOMContentLoaded', () => {
  addPeople(currentItem)
})

function addPeople(item) {
